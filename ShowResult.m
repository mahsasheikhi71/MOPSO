function [Z,Feasible]=ShowResult(pop1,pop2,Pop3,Pop4,Parameter)

Pop1=zeros([1,Parameter.k]);
Pop2=zeros([Parameter.t,Parameter.v]);
for i=1:Parameter.k
    Pop1(i)=find(pop1(:,i)==min(pop1(:,i)));
end
for v=1:Parameter.v
    for t=1:Parameter.t
        Pop2(t,v)=find(pop2(Parameter.r*(t-1)+1:Parameter.r*t,v)==min(pop2(Parameter.r*(t-1)+1:Parameter.r*t,v)));
    end
end
